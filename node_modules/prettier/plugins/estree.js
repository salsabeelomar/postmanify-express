...
Expected it to be ${n}.`}var qn=class extends Error{name="InvalidDocError";constructor(t){super(_o(t)),this.doc=t}},Tt=qn;var Tu={};function jo(e,t,r,n){let s=[e];for(;s.length>0;){let u=s.pop();if(u===Tu){r(s.pop());continue}r&&s.push(u,Tu);let i=nt(u);if(!i)throw new Tt(u);if((t==null?void 0:t(u))!==!1)switch(i){case _e:case Pe:{let a=i===_e?u:u.parts;for(let p=a.length,o=p-1;o>=0;--o)s.push(a[o]);break}case xe:s.push(u.flatContents,u.breakContents);break;case le:if(n&&u.expandedStates)for(let a=u.expandedStates.length,p=a-1;p>=0;--p)s.push(u.expandedStates[p]);else s.push(u.contents);break;case Ye:case Xe:case He:case je:case Ne:s.push(u.contents);break;case et:case tt:case rt:case Ve:case me:case ve:break;default:throw new Tt(u)}}}var Wn=jo;var du=()=>{},$e=du,vr=du;function f(e){return $e(e),{type:Xe,contents:e}}function he(e,t){return $e(t),{type:Ye,contents:t,n:e}}function l(e,t={}){return $e(e),vr(t.expandedStates,!0),{type:le,id:t.id,contents:e,break:!!t.shouldBreak,expandedStates:t.expandedStates}}function xu(e){return he(Number.NEGATIVE_INFINITY,e)}function Mr(e){return he(-1,e)}function Ke(e,t){return l(e[0],{...t,expandedStates:e})}function Rr(e){return vr(e),{type:Pe,parts:e}}function B(e,t="",r={}){return $e(e),t!==""&&$e(t),{type:xe,breakContents:e,flatContents:t,groupId:r.groupId}}function dt(e,t){return $e(e),{type:He,contents:e,groupId:t.groupId,negate:t.negate}}function Gn(e){return $e(e),{type:Ne,contents:e}}var ke={type:Ve},Ee={type:ve};var Un={type:me,hard:!0},vo={type:me,hard:!0,literal:!0},x={type:me},E={type:me,soft:!0},F=[Un,Ee],Jr=[vo,Ee],ir={type:tt};function b(e,t){$e(e),vr(t);let r=[];for(let n=0;n<t.length;n++)n!==0&&r.push(e),r.push(t[n]);return r}function hu(e,t,r){$e(e);let n=e;if(t>0){for(let s=0;s<Math.floor(t/r);++s)n=f(n);n=he(t%r,n),n=he(Number.NEGATIVE_INFINITY,n)}return n}function st(e,t){return $e(t),e?{type:je,label:e,contents:t}:t}function mt(e,t){if(typeof e=="string")return t(e);let r=new Map;return n(e);function n(u){if(r.has(u))return r.get(u);let i=s(u);return r.set(u,i),i}function s(u){switch(nt(u)){case _e:return t(u.map(n));case Pe:return t({...u,parts:u.parts.map(n)});case xe:return t({...u,breakContents:n(u.breakContents),flatContents:n(u.flatContents)});case le:{let{expandedStates:i,contents:a}=u;return i?(i=i.map(n),a=i[0]):a=n(a),t({...u,contents:a,expandedStates:i})}case Ye:case Xe:case He:case je:case Ne:return t({...u,contents:n(u.contents)});case et:case tt:case rt:case Ve:case me:case ve:return t(u);default:throw new Tt(u)}}}function Su(e,t,r){let n=r,s=!1;function u(i){if(s)return!1;let a=t(i);a!==void 0&&(s=!0,n=a)}return Wn(e,u),n}function Mo(e){if(e.type===le&&e.break||e.type===me&&e.hard||e.type===ve)return!0}function re(e){return Su(e,Mo,!1)}function gu(e){if(e.length>0){let t=_(!1,e,-1);!t.expandedStates&&!t.break&&(t.break="propagated")}return null}function Bu(e){let t=new Set,r=[];function n(u){if(u.type===ve&&gu(r),u.type===le){if(r.push(u),t.has(u))return!1;t.add(u)}}function s(u){u.type===le&&r.pop().break&&gu(r)}Wn(e,n,s,!0)}function Ro(e){return e.type===me&&!e.hard?e.soft?"":" ":e.type===xe?e.flatContents:e}function ar(e){return mt(e,Ro)}function Jo(e){switch(nt(e)){case Pe:if(e.parts.every(t=>t===""))return"";break;case le:if(!e.contents&&!e.id&&!e.break&&!e.expandedStates)return"";if(e.contents.type===le&&e.contents.id===e.id&&e.contents.break===e.break&&e.contents.expandedStates===e.expandedStates)return e.contents;break;case Ye:case Xe:case He:case Ne:if(!e.contents)return"";break;case xe:if(!e.flatContents&&!e.breakContents)return"";break;case _e:{let t=[];for(let r of e){if(!r)continue;let[n,...s]=Array.isArray(r)?r:[r];typeof n=="string"&&typeof _(!1,t,-1)=="string"?t[t.length-1]+=n:t.push(n),t.push(...s)}return t.length===0?"":t.length===1?t[0]:t}case et:case tt:case rt:case Ve:case me:case je:case ve:break;default:throw new Tt(e)}return e}function Gt(e){return mt(e,t=>Jo(t))}function Ie(e,t=Jr){return mt(e,r=>typeof r=="string"?b(t,r.split(`
`)):r)}function qo(e){if(e.type===me)return!0}function bu(e){return Su(e,qo,!1)}function or(e,t){return e.type===je?{...e,contents:t(e.contents)}:t(e)}function Wo(e){let t=`*${e.value}*`.split(`
`);return t.length>1&&t.every(r=>r.trimStart()[0]==="*")}var Pu=Wo;function ku(e,t){let r=e.node;if(Ct(r))return t.originalText.slice(q(r),k(r)).trimEnd();if(ee(r))return Pu(r)?Go(r):["/*",Ie(r.value),"*/"];throw new Error("Not a comment: "+JSON.stringify(r))}function Go(e){let t=e.value.split(`
...
`)?Uu(D,y):p;p=C;let c=a[o],A=n[u][o],T=Te(r.originalText,k(m),q(n.quasis[o+1]));if(!T){let g=ts(c,{...r,printWidth:Number.POSITIVE_INFINITY}).formatted;g.includes(`
